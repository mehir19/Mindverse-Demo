...
particlesJS("particles-js", {
    particles: {
        ...
        line_linked: { enable: true, distance: 0, color: "#ffffff", opacity: 0, width: 0 },
        move: { enable: true, speed: 0.2, direction: "bottom", random: false, straight: false, out_mode: "out", bounce: false, attract: { enable: false, rotateX: 600, rotateY: 1200 } },
    },
    interactivity: {
        detect_on: "canvas",
